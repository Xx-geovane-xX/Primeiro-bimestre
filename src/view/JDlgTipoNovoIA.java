...
public class JDlgTipoNovoIA extends javax.swing.JDialog {
    ...
    public GasTipo gasTipo;
    public TipoDAO tipoDAO;
    public JDlgTipoNovo jDlgTipoNovo;
    ...
    public GasTipo viewBean() {
        ...
        gasTipo.setGasPeso(Util.strInt(jTxtPeso.getText()));
        gasTipo.setGasPrecoMedio(Util.strInt(jTxtPrecoMedio.getText()));
        gasTipo.setGasUnidadeDeMedida(jTxtUnidadeDeMedida.getText());
        return gasTipo;
    }

    public void beanView(GasTipo gasTipo) {
        jTxtCodigo.setText(Util.intStr(gasTipo.getGasIdTipo()));
        jTxtNome.setText(gasTipo.getGasNome());
        jTxtPeso.setText(Util.intStr(gasTipo.getGasPeso()));
        jTxtPrecoMedio.setText(Util.intStr(gasTipo.getGasPrecoMedio()));
